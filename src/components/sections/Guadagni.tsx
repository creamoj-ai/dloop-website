...
const kpis = [
  {
    label: "CONSEGNE",
    value: "\u20AC350-500",
    detail: "a settimana consegnando",
  ...
  },
  {
    label: "LA TUA RETE",
    value: "\u20AC200-400",
    detail: "al mese dai clienti e negozianti che porti tu",
    icon: <Users size={20} />,
  ...
  },
  {
    ...
    value: "\u20AC150-300",
    detail: "al mese vendendo i tuoi prodotti nell'app",
    icon: <Wallet size={20} />,
  ...
  },
  {
    label: "PAGAMENTI",
    value: "3 giorni",
    detail: "e i soldi sono sul tuo conto",
    icon: <Clock size={20} />,
