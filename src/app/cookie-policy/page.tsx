...
export const metadata: Metadata = {
  title: "Cookie Policy | dloop",
  description: "Informativa sui cookie di dloop ai sensi delle linee guida del Garante Privacy",
};

// ============================================================
// ISTRUZIONI: Sostituisci INSERISCI_POLICY_ID con il tuo
// Cookie Policy ID di Iubenda (lo trovi nella dashboard)
// ============================================================
      ...
      <main className="min-h-screen pt-24 pb-16 px-4 md:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-surface rounded-lg p-6 md:p-8">
            <iframe
              src={`https://www.iubenda.com/privacy-policy/${IUBENDA_COOKIE_POLICY_ID}/cookie-policy`}
